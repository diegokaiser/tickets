      ...
      <div class="container">
        <div class="row justify-content-center align-items-center h-100">
          <div class="col-5">
            ...
            <h4 class="text-white text-center mt-3">¡Bienvenido  <%=nombre%>!</h4>
            <h4 class="text-white text-center">Necesitarás validar tu correo electrónico (<%=correo%>) para estar seguros de tu identidad.</h4>
